...
from utils.config import concept_samples_10p, concept_samples_20p, concept_samples_30p, concept_samples_40p, concept_samples_50p
    ...
    def __getitem__(self, idx):
        ...
        if self.use_attr:
            if self.uncertain_label:
                ...
                if self.concept_percent == 10:
                    attr_label = [attr_label[index] for index in concept_samples_10p]
                elif self.concept_percent == 20:
                    attr_label = [attr_label[index] for index in concept_samples_20p]
                elif self.concept_percent == 30:
                    attr_label = [attr_label[index] for index in concept_samples_30p]
                elif self.concept_percent == 40:
                    attr_label = [attr_label[index] for index in concept_samples_40p]
                elif self.concept_percent == 50:
                    attr_label = [attr_label[index] for index in concept_samples_50p]
